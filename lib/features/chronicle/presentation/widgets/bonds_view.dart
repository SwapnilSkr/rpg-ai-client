      ...
      child: Material(
        ...
        child: InkWell(
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    if (entry.role != null && entry.role!.trim().isNotEmpty) ...[
          ...
          if (m != null) ...[
            ...
            _Meter(label: 'Trust', value: m.trust, color: EverloreTheme.aether),
            _Meter(label: 'Affection', value: m.affection, color: EverloreTheme.rose),
            _Meter(label: 'Fear', value: m.fear, color: EverloreTheme.ember),
            _Meter(label: 'Rivalry', value: m.rivalry, color: EverloreTheme.crimson),
          ],
