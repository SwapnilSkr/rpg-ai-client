...
class ChronicleRepository {
  ...
  /// Edits a turn and returns the server-regenerated chips, scene presence, and
  /// trackable mentions when the narrative changed (all null/absent when only the
  /// player input was edited).
  static Future<
    ({
      List<Choice> choices,
