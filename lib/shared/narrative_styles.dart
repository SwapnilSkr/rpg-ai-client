...
const StyleFamily famModern = StyleFamily(
  'modern_everyday',
  'Modern & Everyday',
);
const StyleFamily famEpic = StyleFamily('epic_adventure', 'Epic & Adventure');
const StyleFamily famDark = StyleFamily(
  'atmospheric_dark',
  'Atmospheric & Dark',
);
const StyleFamily famRomance = StyleFamily(
  'romance_charged',
  'Romance & Charged',
);
...
const List<NarrativeStyle> kNarrativeStyles = [
  ...
  NarrativeStyle(
    'noir',
    'Noir',
    'Moody, terse, cynical — shadows and edges.',
